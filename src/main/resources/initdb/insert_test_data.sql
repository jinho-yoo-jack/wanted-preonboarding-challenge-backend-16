...
,(DEFAULT, (SELECT id FROM performance limit 1), 1, 1, 'A', 5, 'enable', DEFAULT, DEFAULT)
,(DEFAULT, (SELECT id FROM performance limit 1), 1, 1, 'A', 6, 'enable', DEFAULT, DEFAULT)
,(DEFAULT, (SELECT id FROM performance limit 1), 1, 1, 'A', 7, 'enable', DEFAULT, DEFAULT);
