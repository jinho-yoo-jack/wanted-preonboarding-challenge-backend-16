...
INSERT INTO performance_seat_info (gate, reserved, line, round, seat, performance_id) VALUES
 (1, false, 'A', 1, 1, (SELECT performance_id FROM wanted.performance limit 1))
