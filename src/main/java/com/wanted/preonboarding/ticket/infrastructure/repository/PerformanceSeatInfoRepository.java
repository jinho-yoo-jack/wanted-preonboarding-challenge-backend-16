...
public interface PerformanceSeatInfoRepository extends JpaRepository<PerformanceSeatInfo, Integer> {
	...
	Optional<PerformanceSeatInfo> findByPerformanceIdAndRoundAndSeatInfo(UUID performanceId, int round,
		SeatInfo seatInfo);

	List<PerformanceSeatInfo> findPerformanceSeatInfosByPerformanceIdAndReservedIsFalse(UUID performanceId);

	Optional<PerformanceSeatInfo> findPerformanceSeatInfoBySeatInfoAndPerformanceId(SeatInfo seatInfo,
		UUID performanceId);
}
