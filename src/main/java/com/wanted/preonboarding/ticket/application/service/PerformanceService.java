...
//    @Transactional
//    public ResponseEntity<ResponseHandler<PerformanceDetail>> registerPerformance(RequestPerformance request) {
//        log.info("--- Register Performance ---");
//        Performance performance = performanceRepository.save(request.toEntity());
//        return createResponse(HttpStatus.OK, MESSAGE_SUCCESS, PerformanceDetail.of(seatInfoList));
//    }
